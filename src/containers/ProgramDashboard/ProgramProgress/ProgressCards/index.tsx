  ...
  return (
    <Card className="progress-card" data-testid="progress-card" isLoading={isLoading}>
      <Card.Section className="pt-3 pb-2 px-4">
        <Row>
          <Col xs={12}>
            ...
            <div className="text-muted">{formatMessage(messages.programProgressCardEnrollment)}{' '}{enrollmentInfo}</div>
          </Col>
          <Col
            xs={12}
      ...
      <Card.Section className="pt-3 pb-2 px-4">
        <Row>
          <Col xs={12} md={9}>
            <span className="font-weight-bold">{formatMessage(messages.programProgressCardCertificate)}</span>{' '}
